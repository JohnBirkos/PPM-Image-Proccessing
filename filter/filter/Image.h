...
//------------------------------------ class Image ------------------------------------------------
	...
	class Image:public Array<Vec3<component_t>>
	{
	public:
		                                             
	protected:
		vector<Color> buffer;                              //! Holds the image data.
	...
	public:
		 ...
		 */
		vector<Color> getRawDataPtr() const;
		 ...
		 */
		void setData(const vector<Color> & data_ptr);            
